...
% n = [7, 30, 36, 40, 23, 20, 24, 4, 6, 25, 29, 32, 13, 8, 22, 5, 35, 27, 12, 41, 14, 21, 31, 11, 17, 42, 10, 19, 45, 37, 26, 43, 28, 9, 44, 3, 18, 15, 16, 2, 38, 34, 1, 33, 39]; % RF
...
training_data = num_data_L45(n(1:training_num), feaures_indexes);
checking_data = num_data_L45(n(training_num+1:training_num+validaion_num), feaures_indexes);
testing_data = num_data_L45(n(training_num+validaion_num+1:end), feaures_indexes);

[rows_f, cols_f] = size(feaures_indexes);
