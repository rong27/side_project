...
data = pd.read_csv(r".\data\L45_parameters_averageWidth.csv")
...
print(IQR)
upper_boundary_limit_averageWidth = round(averageWidthP75 + 1.5*IQR, 3)
lower_boundary_limit_averageWidth = round(averageWidthP25 - 1.5*IQR, 3)
e_upper_boundary_limit_averageWidth = round(averageWidthP75 + 3*IQR, 3)
e_lower_boundary_limit_averageWidth = round(averageWidthP25 - 3*IQR, 3)
