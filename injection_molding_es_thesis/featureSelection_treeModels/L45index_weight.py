...
data = pd.read_csv(r".\data\new_L45_index_weight.csv")
print(data.info())

# Weight 五數彙總、boxplot
dataWeight = data['Weight'].describe()

print(dataWeight)
WeightP25 = dataWeight['25%']
WeightP75 = dataWeight['75%']
print(WeightP75)
print(WeightP25)
IQR = WeightP75-WeightP25
print(IQR)
upper_boundary_limit_Weight = round(WeightP75 + 1.5*IQR, 4)
lower_boundary_limit_Weight = round(WeightP25 - 1.5*IQR, 4)
e_upper_boundary_limit_Weight = round(WeightP75 + 3*IQR, 4)
e_lower_boundary_limit_Weight = round(WeightP25 - 3*IQR, 4)
extrem_normal_interval = [e_lower_boundary_limit_Weight, e_upper_boundary_limit_Weight]
normal_interval = [lower_boundary_limit_Weight, upper_boundary_limit_Weight]
print(f'Extreme normal Weight interval : {extrem_normal_interval} ')
print(f'Normal Weight interval : {normal_interval} ')
...
# outlier index
outlierIndex = []
for outlierI, outlierV in enumerate(data['Weight']):
...
plt.title('Weight in Decision Tree-Feature importances', fontsize=14)
plt.show()
...
plt.title('Decision Tree-Weight prediction (train)')
plt.xlabel('No')
plt.ylabel('Weight (g)')
plt.legend()
plt.show()
...
plt.title('Decision Tree-Weight prediction (test)')
plt.xlabel('No')
plt.ylabel('Weight (g)')
plt.legend(loc='best')
plt.show()
...
plt.ylabel('Features', fontsize=14)
plt.yticks(fontsize=14)
plt.title('Weight in Random Forest-Feature importances', fontsize=14)
plt.show()
...
plt.title('Random Forest-Weight prediction (train)')
plt.xlabel('No')
plt.ylabel('Weight (g)')
plt.legend()
plt.show()
...
plt.title('Random Forest-Weight prediction (test)')
plt.xlabel('No')
plt.ylabel('Weight (g)')
plt.legend()
plt.show()
...
plt.plot(x_axis, y_train, 'o', color='lightcoral', label='True', markersize=8)
plt.plot(x_axis, predicted_train, 'o', color='navy', label='Predict(train)', markersize=6)
plt.title('XGBoost-Weight prediction (train)')
plt.xlabel('No')
plt.ylabel('Weight (g)')
plt.legend()
plt.show()
...
plt.plot(x_axis_test, y_test, 'o', color='lightcoral', label='True')
plt.plot(x_axis_test, predicted_test,'o', color='navy', label='Predict(test)')
plt.title('XGBoost-Weight prediction (test)')
plt.xlabel('No')
plt.ylabel('Weight (g)')
plt.legend(loc='best')
plt.show()
...
plt.ylabel('Features', fontsize=14)
plt.yticks(fontsize=14)
plt.title('Weight in XGBoost-Feature importances', fontsize=14)
plt.show()