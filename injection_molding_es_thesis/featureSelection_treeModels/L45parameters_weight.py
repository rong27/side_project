...
data = pd.read_csv(r".\data\L45_parameters_weight.csv")
...
print(IQR)
upper_boundary_limit_Weight = round(WeightP75 + 1.5*IQR, 3)
lower_boundary_limit_Weight = round(WeightP25 - 1.5*IQR, 3)
e_upper_boundary_limit_Weight = round(WeightP75 + 3*IQR, 3)
e_lower_boundary_limit_Weight = round(WeightP25 - 3*IQR, 3)
