...
data = pd.read_csv(r".\data\new_L45_index_averageLength.csv")
...
print(IQR)
upper_boundary_limit_averageWidth = round(averageLengthP75 + 1.5*IQR, 4)
lower_boundary_limit_averageWidth = round(averageLengthP25 - 1.5*IQR, 4)
e_upper_boundary_limit_averageWidth = round(averageLengthP75 + 3*IQR, 4)
e_lower_boundary_limit_averageWidth = round(averageLengthP25 - 3*IQR, 4)
